...
**Marca:** Pix Keno
**PWA:** `https://pwa.app-pixkeno.com`
**Arquivo para envio:** `INSTRUCOES_BANNER_CLUBE_VIP_PIXKENO.md`

## Objetivo

Adicionar uma faixa simples no topo do site principal convidando o usuario a acessar o PWA da Pix Keno.
...
<div id="vip-install-banner" class="vip-install-banner vip-install-banner--expanded" role="region" aria-label="Clube VIP">
  <div class="vip-install-banner__content">
    <img
      ...
      src="https://pwa.app-pixkeno.com/icons/icon-192.svg"
      alt="Pix Keno"
      width="40"
      height="40"
    ...
    <a class="vip-install-banner__cta" href="https://pwa.app-pixkeno.com" target="_blank" rel="noopener noreferrer">
      Instalar app
    </a>
  ...
  <a class="vip-install-banner__mini" href="https://pwa.app-pixkeno.com" target="_blank" rel="noopener noreferrer">
...
|---|---|
| `BRAND_NAME` | `Pix Keno` |
| `PWA_URL` | `https://pwa.app-pixkeno.com` |
| `LOGO_URL` | `https://pwa.app-pixkeno.com/icons/icon-192.svg` |
| `CTA_COLOR` | `#006DFF` |
...
- O clique no botao ou na faixa recolhida deve apontar para `https://pwa.app-pixkeno.com`.
